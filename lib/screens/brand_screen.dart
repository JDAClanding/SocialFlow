...
class _BrandScreenState extends State<BrandScreen> {
  ...
  Future<void> fetchSite() async {
    ...
    s.brand.website = url;
    s.brand.siteText = (d['text'] ?? '')
        .toString()
        .substring(0, (d['text'] ?? '').toString().length.clamp(0, 1500));
    s.save();
    setState(() {
    ...
    toast(
        context,
        siteImages.isEmpty
            ? 'Website read ✓ (no images found)'
            : 'Website read — select your product images');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SplitView(leftFlex: 3, rightFlex: 2, left: [
          SfCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                if (loadingSite)
                  const Thinking(
                      'Reading your website — pulling text & product images…'),
                  ...
                  Column(
                    ...
                    children: [
                      const Padding(
                        ...
                        child: Text(
                            'Product images found on your site — tap to select',
                            style: TextStyle(
                                fontSize: 13,
                      ...
                      LayoutBuilder(
                          builder: (context, box) => GridView.count(
                                crossAxisCount: gridCols(box.maxWidth,
                                    minTile: 110, min: 3),
                                shrinkWrap: true,
                    ...
                    _grow(
                      Field(
                        ...
                        TextFormField(
                          ...
                          decoration:
                              sfInput('e.g., liquor-infused chocolates'),
                          onChanged: (v) {
                            b.product = v;
                            s.save();
                          },
                      ...
                      for (final p in allPlatforms)
                        FilterChip(
                          ...
                          labelStyle: TextStyle(
                              fontSize: 12.5,
                              color:
                                  b.platforms.contains(p) ? C.brand : C.soft),
          ...
          if (b.productImages.isNotEmpty)
            SfCard(
              child: Column(
                ...
                children: [
                  Text(
                      'Your product images (${b.productImages.length} selected)',
                  ...
                  LayoutBuilder(
                      builder: (context, box) => GridView.count(
                            crossAxisCount:
                                gridCols(box.maxWidth, minTile: 110, min: 3),
                            shrinkWrap: true,
                            physics: const NeverScrollableScrollPhysics(),
                            mainAxisSpacing: 10,
                            crossAxisSpacing: 10,
            ...
            const SfCard(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                      'Add your website and tap “Read my site” — the product photos it finds appear here. '
                      'They guide the AI Studio so generated visuals match your real product.',
                      style: TextStyle(
                          fontSize: 12.5, color: C.soft, height: 1.4)),
                ],
              ),
            ),
        ]),
  ...
  /// Expanded in a Row, natural height in a Column (mobile).
  Widget _grow(Widget child) =>
      Responsive.isMobile(context) ? child : Expanded(child: child);
}
